            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('products.my_offers')" :active="request()->routeIs('products.my_offers')">
                            {{ __('My Offers') }}
                        </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('products.my_offers')" :active="request()->routeIs('products.my_offers')">
                    {{ __('My Offers') }}
                </x-responsive-nav-link>
